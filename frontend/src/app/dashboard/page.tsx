              ...
              <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 p-8 flex flex-col sm:flex-row justify-between sm:items-center">
                ...
                <div className="mt-4 sm:mt-0 flex flex-col sm:flex-row gap-3">
                  <button 
                    ...
                    className="inline-flex items-center justify-center bg-white/10 backdrop-blur-sm text-white border border-white/30 px-5 py-2.5 rounded-lg hover:bg-white/20 font-semibold transition-all"
                  >
          ...
          <div className="bg-white rounded-2xl p-8 w-full max-w-md shadow-2xl transform transition-all">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row-reverse gap-3 pt-4">
                <button 
                  type="submit" 
                  className="w-full bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 font-semibold transition-colors shadow-sm"
                >
                  Save Changes
                </button>
                <button 
                  ...
                  className="w-full bg-slate-100 text-slate-700 py-3 rounded-lg hover:bg-slate-200 font-semibold transition-colors"
                >
                  Cancel
                </button>
              </div>
